...
import { CampDetailsContainer } from "./CampDetailsPage.styled";
import {
  Calendar,
  Clock,
  Eye,
...
import { campDetailsBreadcrumbsItems } from "@/constants/breadcrumbs.constants";
...
const CampDetailsPage: React.FC = () => {
  ...
  return (
    <CampDetailsContainer>
      <div className="!p-3 sm:!py-[25.79px] !px-[40px]">
        {/* Header */}
        <CommonBreadCrumbs
          className="!mb-[13.88]"
          items={campDetailsBreadcrumbsItems}
        />
        <p className="!text-[28px] font-semibold !text-[#222E62]">
          Stress Management Camp
        </p>
        <div className="flex gap-2 sm:justify-between sm:items-center !mb-[21.72px] flex-col sm:flex-row">
          <div>
            <span className="!px-[14.09px] !py-[10.97px] border-[#16B670] border-[1px] text-green-600 rounded-full text-sm">
              Completed
            </span>
          </div>
          <div className="flex gap-[18.82px]">
            <SecoundaryButton className="sm:!py-[10px]">
              Share Register Link
            </SecoundaryButton>
            <PrimaryButton className="sm:!py-[10px]">
              Schedule Next Camp
            </PrimaryButton>
          </div>
        </div>

        <div className="grid md:grid-cols-4 xl:grid-cols-3  gap-4 !mb-[40.5px]">
          {/* Lab Vendor Info */}
          <div className="border cards-shadow !border-[#92BDF6] rounded-[25px] p-3 col-span-4 xl:col-span-1">
            <div className="mb-2">
          ...
          {/* Package Utilization */}
          <div className="border !border-[#92BDF6] cards-shadow rounded-[25px] p-3 col-span-4 md:col-span-2 xl:col-span-1">
          ...
          <div className="border !border-[#92BDF6] cards-shadow rounded-[25px] p-3 col-span-4 md:col-span-2 xl:col-span-1">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-1 text-gray-400">
                <button className="bg-gradient-to-b from-[#252B61] to-[#4C58C7] flex justify-center items-center p-1 !rounded-[7px] h-[24px] w-[24px]">
                  <Eye color="#92BDF6" size={20} />
                </button>
                <button className="bg-gradient-to-b from-[#252B61] to-[#4C58C7] flex justify-center items-center p-1 !rounded-[7px] h-[24px] w-[24px]">
                  <Maximize2 color="#92BDF6" size={20} />
                </button>
                <button className="bg-gradient-to-b from-[#252B61] to-[#4C58C7] flex justify-center items-center p-1 !rounded-[7px] h-[24px] w-[24px]">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[1, 2].map((i) => (
                <div
                  key={i}
                  className="border-1 border-[#70BEFF] rounded-[10px] p-1 border-dashed bg-gray-50 h-[100px]"
                >
                  <img
                    className="w-full h-full"
                    src="https://raphacure-public-images.s3.ap-south-1.amazonaws.com/119535-1746173036241.png"
                    alt="emailer-template"
                  />
                </div>
              ))}
            </div>
        ...
        <div className="flex justify-between items-center gap-1 !mb-[27.5px] top-header-responsive">
          <div>
