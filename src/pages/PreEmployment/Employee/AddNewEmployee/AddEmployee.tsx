...
const PreEmploymentAddEmployeePage = () => {
  ...
  const bulkEmployeeBreadcrumbs = [
    ...
    },
    {
      ...
      link: `/package/${packageType?.type}/employee/add-bulk-employee`,
    },
  ];
      ...
      <div className="!px-[39px] !py-[48.7px] bg-white rounded-lg">
        ...
        <div className="flex justify-between items-center !mb-[24.24px]">
          ...
          <SecoundaryButton
            ...
            onClick={() =>
              navigate(`/package/${packageType?.type}/employee/add-bulk-employee`)
            }
          >
            Bulk Upload
          </SecoundaryButton>
        ...
        <div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <Input className="h-10 !rounded-[10px]" />
              </Form.Item>
              ...
              >
                <Radio.Group>
                  <div className="grid grid-cols-3 gap-[20px] h-[54px]">
                    <Radio.Button
                      value="Male"
              ...
              >
                <Input className="h-10 !rounded-[10px]" maxLength={10} />
              </Form.Item>
              ...
              <Form.Item
                ...
                rules={[
                  ...
                  {
                    pattern: /^\d{1,6}$/,
                    message: "Pincode must be at most 6 digits",
                  },
                ]}
              >
                <Input className="h-10 !rounded-[10px]" maxLength={6} />
              </Form.Item>
            </div>
...
export default PreEmploymentAddEmployeePage;
